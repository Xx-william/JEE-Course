			...
			<div class="panel-body">
				...
				<form id="newProjectForm" method="post" data-toggle="validator">
					...
					<div class="form-group">
						...
						<!--  
						<textarea class="form-control" rows="3" id="inputDesctiption"
							placeholder="Desctiption" name="descrption" required></textarea>
						 -->
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<div class="form-group">
								...
								<label class="control-label">Incubation # of days:</label> <input
									type="number" class="form-control" id="inputIncubation"
									placeholder="Incubation" name="incubation" required>
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">

								<label class="control-label">Budget(EUR):</label> <input
									type="number" class="form-control" id="inputBudget"
									placeholder="Budget" name="budget" required>
							</div>
						</div>
					</div>
